...
async function fetchImages(search, page) {
    const response = await axios.get(`${URL}/?${KEY}=${search}&page=${page}&per_page=40&image_type=photo&orientation=horizontal&safesearch=true`);
    return response.data;
}

},{"notiflix":"5z0Oc","notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
